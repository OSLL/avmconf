...
**
** Created: Wed May 23 17:09:40 2012
...
void ContainerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ContainerDialog *_t = static_cast<ContainerDialog *>(_o);
        switch (_id) {
        case 0: _t->destroyPressed(); break;
        case 1: _t->cancelDestroyPressed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ContainerDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ContainerDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ContainerDialog,
      qt_meta_data_ContainerDialog, &staticMetaObjectExtraData }
};
