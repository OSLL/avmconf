...
**
** Created: Wed May 23 17:00:05 2012
...
const QMetaObject ParameterWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ParameterWidget,
      qt_meta_data_ParameterWidget, 0 }
};
...
int ParameterWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: parameterChanged((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< Value*(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
