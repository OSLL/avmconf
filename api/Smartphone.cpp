...
std::vector<Parameter*> Smartphone::getContainerParametersList() const
{ 
    return std::vector<Parameter*>();
}

std::vector<Parameter*> Smartphone::getDeviceParametersList() const
{
    return std::vector<Parameter*>();    
}

std::vector<Value*> Smartphone::getContainerParametersValues(const std::string &containerId) const
{
    return std::vector<Value*>();
}

std::vector<Value*> Smartphone::getDeviceParametersValues() const
{
    return std::vector<Value*>();
}
